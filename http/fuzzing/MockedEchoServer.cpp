...
extern "C" int LLVMFuzzerInitialize(int *argc, char ***argv) {
    ...
    app = new Ouroborus::TemplatedApp<false>(Ouroborus::App().ws<PerSocketData>("/*", {
        /* Settings */
        .compression = Ouroborus::SHARED_COMPRESSOR,
        ...
        .message = [](auto *ws, std::string_view message, Ouroborus::OpCode opCode) {
