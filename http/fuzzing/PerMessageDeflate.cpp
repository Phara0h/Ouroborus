...
struct StaticData {
    Ouroborus::ZlibContext zlibContext;

    Ouroborus::InflationStream inflationStream;
    Ouroborus::DeflationStream deflationStream = Ouroborus::DEDICATED_COMPRESSOR_8KB;
} staticData;
