...
struct AsyncFileStreamer {
    ...
    template <bool SSL>
    void streamFile(Ouroborus::HttpResponse<SSL> *res, std::string_view url) {
    ...
    template <bool SSL>
    static void streamFile(Ouroborus::HttpResponse<SSL> *res, AsyncFileReader *asyncFileReader) {
        /* Peek from cache */
