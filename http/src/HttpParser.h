...
#ifndef OUROBORUS_HTTPPARSER_H
#define OUROBORUS_HTTPPARSER_H
...
private:
        ...
        std::pair<int, std::pair<std::string_view,std::string_view> *> currentParameters;
...
public:
        ...
        std::pair<int, Header *> getHeaders() {
                return std::make_pair(MAX_HEADERS, headers);
        }
        ...
        void setParameters(std::pair<int, std::pair<std::string_view,std::string_view> *> parameters) {
        ...
        std::string_view getParameter(unsigned int index) {
                if (currentParameters.first < (int) index) {
                        ...
                        return currentParameters.second[index].second;
                }
        }
