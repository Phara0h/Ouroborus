...
#ifndef OUROBORUS_HTTPCONTEXT_H
#define OUROBORUS_HTTPCONTEXT_H
...
private:
    ...
    HttpContext<SSL> *init() {
        ...
        us_socket_context_on_data(SSL, getSocketContext(), [](us_socket_t *s, char *data, int length) {
            ...
            void *returnedSocket = httpResponseData->consumePostPadded(data, length, s, [httpContextData](void *s, Ouroborus::HttpRequest *httpRequest) -> void * {
